    ...
    context: [
      {
        ...
        kind: "choice",
        options: [
          { value: "parents", label: "My parents", phrase: "it's my parents asking" },
          { value: "employer", label: "An employer", phrase: "it's an employer asking" },
          { value: "landlord", label: "A landlord", phrase: "it's a landlord asking" },
          { value: "student", label: "Another student", phrase: "it's another student asking" },
        ],
      },
      {
        id: "dependent",
    ...
    context: [
      {
        ...
        kind: "choice",
        options: [
          { value: "student", label: "Another student", phrase: "it's another student" },
          { value: "instructor", label: "A TA or instructor", phrase: "it's a TA or instructor" },
          { value: "staff", label: "A staff member", phrase: "it's a university staff member" },
          { value: "outside", label: "Someone not from UCSD", phrase: "it's someone who isn't a UCSD student or employee" },
        ],
      },
      {
        id: "where",
